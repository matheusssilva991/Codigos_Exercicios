...
int main(){
    ...
    code[ 10].f = LIT; code[ 10].l = 0; code[ 10].a = 100;
    code[ 11].f = OPR; code[ 11].l = 0; code[ 11].a = 11;
    code[ 12].f = JPC; code[ 12].l = 0; code[ 12].a = 18;
    code[ 13].f = LOD; code[ 13].l = 0; code[ 13].a = 4;
    code[ 14].f = LIT; code[ 14].l = 0; code[ 14].a = 1;
    code[ 15].f = OPR; code[ 15].l = 0; code[ 15].a = 2;
    code[ 16].f = STO; code[ 16].l = 0; code[ 16].a = 4;
    code[ 17].f = JMP; code[ 17].l = 0; code[ 17].a = 5;
