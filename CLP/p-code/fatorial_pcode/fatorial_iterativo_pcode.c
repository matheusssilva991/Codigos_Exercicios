...
int main(){
    ...
    code[ 1].f = LIT; code[ 1].l = 0; code[ 1].a = 4; //s[t] = 4
    ...
    code[ 5].f = CAL; code[ 5].l = 0; code[ 5].a = 7; //fat_iterativo(s[3])
    code[ 6].f = OPR; code[ 6].l = 0; code[ 6].a = 0;

    //Fatorial Iterativo
    code[ 7].f = INT; code[ 7].l = 0; code[ 7].a = 5;
    code[ 8].f = LOD; code[ 8].l = 0; code[ 8].a = 3;     //s[t] = s[7]
    code[ 9].f = STO; code[ 9].l = 0; code[ 9].a = 4;     //s[8] = s[t]
    code[ 10].f = LOD; code[ 10].l = 0; code[ 10].a = 4;  //s[t] = s[8]
    code[ 11].f = LIT; code[ 11].l = 0; code[ 11].a = 3;  //s[t] = 3
    code[ 12].f = OPR; code[ 12].l = 0; code[ 12].a = 10; //s[t] = s[t] < s[t + 1]
    code[ 13].f = JPC; code[ 13].l = 0; code[ 13].a = 23; //p = s[t] == 1 ? OPR 0 0 : continue 
    code[ 14].f = LOD; code[ 14].l = 0; code[ 14].a = 4;  //s[t] = s[7]
    code[ 15].f = LIT; code[ 15].l = 0; code[ 15].a = 1;  //s[t] = 1
    code[ 16].f = OPR; code[ 16].l = 0; code[ 16].a = 3;  //s[t] = s[t] - 1
    code[ 17].f = STO; code[ 17].l = 0; code[ 17].a = 4;  //s[8] = s[t]
    code[ 18].f = LOD; code[ 18].l = 0; code[ 18].a = 3;  //s[t] = s[7]
    code[ 19].f = LOD; code[ 19].l = 0; code[ 19].a = 4;  //s[t] = s[8]
    code[ 20].f = OPR; code[ 20].l = 0; code[ 20].a = 4;  //s[t] = s[7] * s[8]
    code[ 21].f = STO; code[ 21].l = 0; code[ 21].a = 3;  //s[7] = s[t]
    code[ 22].f = JMP; code[ 22].l = 0; code[ 22].a = 10; //p = 10 
    code[ 23].f = LOD; code[ 23].l = 0; code[ 23].a = 3;  //s[t] = s[7]
    code[ 24].f = STO; code[ 24].l = 1; code[ 24].a = 3;  //s[3] = s[t]
    code[ 25].f = OPR; code[ 25].l = 0; code[ 25].a = 0;  //return main
