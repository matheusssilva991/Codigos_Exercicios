...
int main(){
    ...
    code[ 4].f = STO; code[ 4].l = 0; code[ 4].a = 7;
    ...
    code[ 14].f = OPR; code[ 14].l = 0; code[ 14].a = 13;
    code[ 15].f = JPC; code[ 15].l = 0; code[ 15].a = 25;
    code[ 16].f = LOD; code[ 16].l = 0; code[ 16].a = 4;
    code[ 17].f = LIT; code[ 17].l = 0; code[ 17].a = 1;
    code[ 18].f = OPR; code[ 18].l = 0; code[ 18].a = 3;
    code[ 19].f = STO; code[ 19].l = 0; code[ 19].a = 4;
