...
int main(){
    ...
    code[ 5].f = CAL; code[ 5].l = 0; code[ 5].a = 9; //fat_iterativo(s[3])
    code[ 6].f = LOD; code[ 6].l = 0; code[ 6].a = 7;
    code[ 7].f = STO; code[ 7].l = 0; code[ 7].a = 3;
    code[ 8].f = OPR; code[ 8].l = 0; code[ 8].a = 0;

    //Fatorial recursivo
    code[ 9].f = INT; code[ 9].l = 0; code[ 9].a = 4;
    code[ 10].f = LOD; code[ 10].l = 0; code[ 10].a = 3;     //s[t] = s[7]
    code[ 11].f = LIT; code[ 11].l = 0; code[ 11].a = 2;  //s[t] = 2
    ...
    code[ 17].f = STO; code[ 17].l = 0; code[ 17].a = 7;  //s[7 + nova chamada funcao] = s[t]
    code[ 18].f = CAL; code[ 18].l = 0; code[ 18].a = 9; //p = 9 
    code[ 19].f = LOD; code[ 19].l = 0; code[ 19].a = 3;  //s[t] = s[7]
    code[ 20].f = LOD; code[ 20].l = 0; code[ 20].a = 7;  //s[t] = s[8]
    code[ 21].f = OPR; code[ 21].l = 0; code[ 21].a = 4;  //s[t] = s[7] * s[8]
    code[ 22].f = STO; code[ 22].l = 0; code[ 22].a = 3;  //s[7] = s[t]
    code[ 23].f = OPR; code[ 23].l = 0; code[ 23].a = 0;  //return main
